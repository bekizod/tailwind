...
const Footer = () => {
  return (
    <footer className="bg-gray-800 py-3 w-full 2xl:h-[20vh] ">
    <div className="font-bold text-cyan-400 text-lg text-center mb-4  border-b">Contact Me</div>
      <div className="container w-full flex flex-row justify-center items-center gap-5  md:gap-7 lg:gap-20 xl:gap-60 ">
        <a
